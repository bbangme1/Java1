...
public class Board {
	...
	public Board(String title, String writer, int hit) {
		...
		this.writer = writer; // 게시판 작성자
		this.hit = hit; // 게시글 조회수
	}
...
//	게시글의 작성자가 아니면 수정 할 수 없다.
	...
	public void titleChange( String who, String title ) {
...
/*
 	...
 	1. 메개변수 없고, 반환(return) 없는 메서드
 	public void 메서드이름(	){	}
 	
 	2. 메개변수만 있는 메서드
 	public void 메서드이름( 메개변수1, 메개변수2 ){	}
 	
 	3. 반환(return)만 있는 메서드
 	public String 메서드이름( ){ return String변수; }
 	
 	4. 메개변수 있고, 반환(return)도 있는 메서드
 	public int 메서드이름( 메개변수1, 메개변수2 ){ return int변수;}
